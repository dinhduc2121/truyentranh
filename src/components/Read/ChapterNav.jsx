...
>
  <div className="max-w-4xl mx-auto flex items-center justify-between px-4 py-2">
    ...
    <button
      ...
      className="p-2 rounded bg-blue-300 hover:bg-gray-700/20 text-black"
      title="Mở menu"
    >
      ☰
    </button>
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        ...
        {showChapterList && (
          <div className="absolute top-full left-0 z-10 mt-2 w-48 bg-black rounded shadow border border-gray-200">
            {renderChapterList()}
          </div>
        )}
      </div>
