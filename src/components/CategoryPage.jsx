    ...
    <div className="max-w-7xl mx-auto px-2 md:px-4 py-4 min-h-screen bg-white text-black">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-64 flex-shrink-0">
          <div className="bg-white border rounded shadow p-4 sticky top-20">
            <div className="font-bold text-lg mb-2 text-[#2196f3]">Thể loại</div>
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
              <Link
                to="/the-loai"
                className={`font-semibold hover:text-[#ff4e8a] ${!slug ? "text-[#ff4e8a]" : "text-gray-800"}`}
              >
                Tất cả
              </Link>
              {categories.map(cat => (
                <Link
                  ...
                  className={`hover:text-[#ff4e8a] ${cat.slug === slug ? "text-[#ff4e8a] font-semibold" : "text-gray-800"}`}
                >
                  {cat.name}
                </Link>
              ))}
